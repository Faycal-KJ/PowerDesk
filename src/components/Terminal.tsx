...
export default function Terminal() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(4px)' }} onClick={() => setOpenTool(null)}>
      <div className="floating-panel" style={{ background: '#0d1117', border: '1px solid rgba(255, 255, 255, 0.06)', borderRadius: 'var(--radius-lg)', width: 640, height: 420, display: 'flex', flexDirection: 'column', boxShadow: '0 4px 8px rgba(0,0,0,0.15), 0 16px 48px rgba(0,0,0,0.3)', overflow: 'hidden' }} onClick={(e) => e.stopPropagation()}>
