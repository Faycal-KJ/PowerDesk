...
export default function TopBar() {
  ...
  const sep = <div style={{ width: 1, height: 18, background: 'var(--border-subtle)', flexShrink: 0, margin: '0 2px' }} />
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '0 1px 2px rgba(0,0,0,0.1), 0 4px 16px rgba(0,0,0,0.08)',
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '7px 14px', width: '100%' }}>
      {/* Sidebar toggle */}
      <button
          ...
          <>
            ...
            <div style={{
              ...
              {tabs.filter((t) => t.id !== activeTabId).map((t) => (
                ...
                }} style={{ display: 'flex', alignItems: 'center', gap: 10, width: '100%', padding: '8px 16px', fontSize: 12.5, color: 'var(--text-primary)', background: 'transparent', textAlign: 'left', cursor: 'pointer', transition: 'background 120ms ease' }}
      ...
      {/* Row 2: Tabs */}
      <div style={{ display: 'flex', alignItems: 'center', padding: '0 12px 6px', gap: 2 }}>
        <TabBar embedded />
      </div>
    </div>
  )
